    ...
    it('upload + compute', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    a = dl.zeros([10, 10]);
                    return [4, dl.time(function () { return a.square(); })];
                case 1:
                    time = _a.sent();
    ...
    it('upload + compute + dataSync', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    a = dl.zeros([10, 10]);
                    return [4, dl.time(function () { return a.square().dataSync(); })];
                case 1:
                    time = _a.sent();
                    expect(time.uploadWaitMs > 0);
                    expect(time.downloadWaitMs > 0);
    ...
    it('upload + compute + data', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    a = dl.zeros([10, 10]);
                    return [4, dl.time(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    a = dl.zeros([10, 10]);
                    a.square();
                    return [4, dl.time(function () { return a.sqrt(); })];
                case 1:
                    time = _a.sent();
                    expect(time.uploadWaitMs === 0);
                    expect(time.downloadWaitMs === 0);
