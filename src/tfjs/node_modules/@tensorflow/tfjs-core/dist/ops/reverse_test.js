...
test_util_1.describeWithFlags('reverse1d', test_util_1.ALL_ENVS, function () {
    it('reverse a 1D array', function () {
        var input = dl.tensor1d([1, 2, 3, 4, 5]);
        var result = dl.reverse1d(input);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [5, 4, 3, 2, 1]);
    });
    it('grad', function () {
        var a = dl.tensor1d([1, 2, 3]);
        var dy = dl.tensor1d([10, 20, 30]);
        var da = dl.grad(function (a) { return dl.reverse1d(a); })(a, dy);
...
test_util_1.describeWithFlags('reverse2d', test_util_1.ALL_ENVS, function () {
    it('reverse a 2D array at axis [0]', function () {
        ...
        var result = dl.reverse2d(a, axis);
    ...
    it('throws error with invalid input', function () {
        var x = dl.tensor1d([1, 20, 300, 4]);
        expect(function () { return dl.reverse2d(x, [0]); }).toThrowError();
    });
    it('throws error with invalid axis param', function () {
        var x = dl.tensor2d([1, 20, 300, 4], [1, 4]);
        expect(function () { return dl.reverse2d(x, [2]); }).toThrowError();
        expect(function () { return dl.reverse2d(x, [-3]); }).toThrowError();
    });
    it('throws error with non integer axis param', function () {
        var x = dl.tensor2d([1, 20, 300, 4], [1, 4]);
        expect(function () { return dl.reverse2d(x, [0.5]); }).toThrowError();
    });
    it('grad', function () {
        var a = dl.tensor2d([[1, 2, 3], [4, 5, 6]]);
        var dy = dl.tensor2d([[10, 20, 30], [40, 50, 60]]);
        var da = dl.grad(function (a) { return dl.reverse2d(a); })(a, dy);
    ...
    it('grad with reverse(axis=0)', function () {
        var a = dl.tensor2d([[1, 2, 3], [4, 5, 6]]);
        var dy = dl.tensor2d([[10, 20, 30], [40, 50, 60]]);
        var da = dl.grad(function (a) { return dl.reverse2d(a, 0); })(a, dy);
        expect(da.shape).toEqual([2, 3]);
    ...
    it('grad with reverse(axis=1)', function () {
        var a = dl.tensor2d([[1, 2, 3], [4, 5, 6]]);
        var dy = dl.tensor2d([[10, 20, 30], [40, 50, 60]]);
        var da = dl.grad(function (a) { return dl.reverse2d(a, 1); })(a, dy);
        expect(da.shape).toEqual([2, 3]);
...
test_util_1.describeWithFlags('reverse3d', test_util_1.ALL_ENVS, function () {
    ...
    it('reverse a 3D array at axis [0]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [0]);
        expect(result.shape).toEqual(input.shape);
    ...
    it('reverse a 3D array at axis [1]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [1]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 3D array at axis [2]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [2]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 3D array at axis [0, 1]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [0, 1]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
            20, 21, 22, 23, 16, 17, 18, 19, 12, 13, 14, 15,
            8, 9, 10, 11, 4, 5, 6, 7, 0, 1, 2, 3
    ...
    it('reverse a 3D array at axis [0, 2]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [0, 2]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
            15, 14, 13, 12, 19, 18, 17, 16, 23, 22, 21, 20,
            3, 2, 1, 0, 7, 6, 5, 4, 11, 10, 9, 8
    ...
    it('reverse a 3D array at axis [1, 2]', function () {
        var input = dl.tensor3d(data, shape);
        var result = dl.reverse3d(input, [1, 2]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('throws error with invalid input', function () {
        var x = dl.tensor2d([1, 20, 300, 4], [1, 4]);
        expect(function () { return dl.reverse3d(x, [1]); }).toThrowError();
    });
    it('throws error with invalid axis param', function () {
        var x = dl.tensor3d([1, 20, 300, 4], [1, 1, 4]);
        expect(function () { return dl.reverse3d(x, [3]); }).toThrowError();
        expect(function () { return dl.reverse3d(x, [-4]); }).toThrowError();
    });
    it('throws error with non integer axis param', function () {
        var x = dl.tensor3d([1, 20, 300, 4], [1, 1, 4]);
        expect(function () { return dl.reverse3d(x, [0.5]); }).toThrowError();
    });
});
test_util_1.describeWithFlags('reverse4d', test_util_1.ALL_ENVS, function () {
    ...
    it('reverse a 4D array at axis [0]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [0]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 4D array at axis [1]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [1]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 4D array at axis [2]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [2]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 4D array at axis [3]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [3]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 4D array at axis [0, 2]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [0, 2]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('reverse a 4D array at axis [1, 3]', function () {
        var input = dl.tensor4d(data, shape);
        var result = dl.reverse4d(input, [1, 3]);
        expect(result.shape).toEqual(input.shape);
        test_util_1.expectArraysClose(result, [
    ...
    it('throws error with invalid input', function () {
        var x = dl.tensor3d([1, 20, 300, 4], [1, 1, 4]);
        expect(function () { return dl.reverse4d(x, [1]); }).toThrowError();
    });
    it('throws error with invalid axis param', function () {
        var x = dl.tensor4d([1, 20, 300, 4], [1, 1, 1, 4]);
        expect(function () { return dl.reverse4d(x, [4]); }).toThrowError();
        expect(function () { return dl.reverse4d(x, [-5]); }).toThrowError();
    });
    it('throws error with non integer axis param', function () {
        var x = dl.tensor4d([1, 20, 300, 4], [1, 1, 1, 4]);
        expect(function () { return dl.reverse4d(x, [0.5]); }).toThrowError();
    });
});
