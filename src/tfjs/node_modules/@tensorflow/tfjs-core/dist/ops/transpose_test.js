...
test_util_1.describeWithFlags('transpose', test_util_1.ALL_ENVS, function () {
    ...
    it('gradient 3D [r, c, d] => [d, c, r]', function () {
        var t = dl.tensor3d([1, 11, 2, 22, 3, 33, 4, 44], [2, 2, 2]);
        var perm = [2, 1, 0];
        var dy = dl.tensor3d([111, 211, 121, 221, 112, 212, 122, 222], [2, 2, 2]);
        var dt = dl.grad(function (t) { return t.transpose(perm); })(t, dy);
