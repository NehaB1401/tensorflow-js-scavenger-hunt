...
test_util_1.describeWithFlags('localResponseNormalization with Tensor3D', test_util_1.ALL_ENVS, function () {
    it('throws error with invalid input', function () {
        ...
        var radius = 3;
        expect(function () { return x.localResponseNormalization(radius); })
            .toThrowError();
    });
    ...
    it('computes complex normalization across channels', function () {
        var x = dl.tensor3d([1, 20, 300, 4, 5, 15, 24, 200, 1, 20, 300, 4, 5, 15, 24, 200], [2, 2, 4]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
        var normRegion = "acrossChannels";
        var result = x.localResponseNormalization(radius, bias, alpha, beta, normRegion);
        var f = function () {
            var vals = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                vals[_i] = arguments[_i];
    ...
    it('computes simple normalization within channel', function () {
        var x = dl.tensor3d([1, 20, 300, 4], [2, 2, 1]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
    ...
    it('computes complex normalization within channel', function () {
        var x = dl.tensor3d([
    ...
    it('yields same result as tensorflow', function () {
        ...
        var x = dl.tensor3d(flatten(input), [3, 3, 8]);
        var radius = 2;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
...
test_util_1.describeWithFlags('localResponseNormalization with Tensor4D', test_util_1.ALL_ENVS, function () {
    ...
    it('computes simple normalization across channels', function () {
        var x = dl.tensor4d([1, 20, 300, 4, 1, 20, 300, 4], [2, 1, 1, 4]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
    ...
    it('computes simple normalization within channel', function () {
        var x = dl.tensor4d([1, 20, 50, 4, 1, 20, 50, 4], [2, 2, 2, 1]);
        var radius = 1;
        var bias = 1;
        var alpha = 1;
        var beta = 0.5;
    ...
    it('yields same result as tensorflow', function () {
        ...
        var x = dl.tensor4d(flatten(input), [2, 3, 3, 8]);
        var radius = 2;
