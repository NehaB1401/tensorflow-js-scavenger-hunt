...
test_util_1.describeWithFlags('axis_util getUndoAxesPermutation', [{}], function () {
    it('4d axes', function () {
        var axes = [2, 0, 1, 3];
    ...
    it('4d array with values', function () {
        ...
        var a = dl.randomNormal([2, 3, 4, 5]);
        var aT = dl.transpose(a, axes);
        var aTT = dl.transpose(aT, undoPermutation);
