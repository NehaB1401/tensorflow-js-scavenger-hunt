...
test_util_1.describeWithFlags('concat1d', test_util_1.ALL_ENVS, function () {
    it('3 + 5', function () {
        var a = dl.tensor1d([3]);
        var b = dl.tensor1d([5]);
        var result = dl.concat1d([a, b]);
        var expected = [3, 5];
        test_util_1.expectArraysClose(result, expected);
    });
    it('3 + [5,7]', function () {
        var a = dl.tensor1d([3]);
        var b = dl.tensor1d([5, 7]);
        var result = dl.concat1d([a, b]);
        var expected = [3, 5, 7];
        test_util_1.expectArraysClose(result, expected);
    });
    it('[3,5] + 7', function () {
        var a = dl.tensor1d([3, 5]);
        var b = dl.tensor1d([7]);
        var result = dl.concat1d([a, b]);
        var expected = [3, 5, 7];
        test_util_1.expectArraysClose(result, expected);
...
test_util_1.describeWithFlags('concat2d', test_util_1.ALL_ENVS, function () {
    it('[[3]] + [[5]], axis=0', function () {
        var axis = 0;
        var a = dl.tensor2d([3], [1, 1]);
        var b = dl.tensor2d([5], [1, 1]);
        var result = dl.concat2d([a, b], axis);
        var expected = [3, 5];
    ...
    it('[[1, 2],[3, 4]] + [[5, 6]] + [[7, 8]], axis=0', function () {
        ...
        var b = dl.tensor2d([[5, 6]]);
        var c = dl.tensor2d([[7, 8]]);
        var result = dl.concat2d([a, b, c], axis);
    ...
    it('[[1, 2], [3, 4]] + [[5, 6]], axis=1 throws error', function () {
        ...
        var a = dl.tensor2d([[1, 2], [3, 4]], [2, 2]);
        var b = dl.tensor2d([[5, 6]], [1, 2]);
        expect(function () { return dl.concat2d([a, b], axis); }).toThrowError();
    });
    it('[[1, 2], [3, 4]] + [[5, 6], [7, 8]], axis=1', function () {
        var axis = 1;
        var a = dl.tensor2d([[1, 2], [3, 4]], [2, 2]);
        var b = dl.tensor2d([[5, 6], [7, 8]], [2, 2]);
        var result = dl.concat2d([a, b], axis);
...
test_util_1.describeWithFlags('concat3d', test_util_1.ALL_ENVS, function () {
    it('shapes correct concat axis=0', function () {
        var tensor1 = dl.tensor3d([1, 2, 3], [1, 1, 3]);
        var tensor2 = dl.tensor3d([4, 5, 6], [1, 1, 3]);
        var values = dl.concat3d([tensor1, tensor2], 0);
        expect(values.shape).toEqual([2, 1, 3]);
        test_util_1.expectArraysClose(values, [1, 2, 3, 4, 5, 6]);
    });
    it('concat axis=0', function () {
        var tensor1 = dl.tensor3d([1, 11, 111, 2, 22, 222], [1, 2, 3]);
        var tensor2 = dl.tensor3d([5, 55, 555, 6, 66, 666, 7, 77, 777, 8, 88, 888], [2, 2, 3]);
        var values = dl.concat3d([tensor1, tensor2], 0);
    ...
    it('shapes correct concat axis=1', function () {
        var tensor1 = dl.tensor3d([1, 2, 3], [1, 1, 3]);
        var tensor2 = dl.tensor3d([4, 5, 6], [1, 1, 3]);
        var values = dl.concat3d([tensor1, tensor2], 1);
        expect(values.shape).toEqual([1, 2, 3]);
        test_util_1.expectArraysClose(values, [1, 2, 3, 4, 5, 6]);
    });
    it('concat axis=1', function () {
        var tensor1 = dl.tensor3d([1, 11, 111, 3, 33, 333], [2, 1, 3]);
        var tensor2 = dl.tensor3d([5, 55, 555, 6, 66, 666, 7, 77, 777, 8, 88, 888], [2, 2, 3]);
        var values = dl.concat3d([tensor1, tensor2], 1);
    ...
    it('shapes correct concat axis=2', function () {
        var tensor1 = dl.tensor3d([1, 2, 3], [1, 1, 3]);
        var tensor2 = dl.tensor3d([4, 5, 6], [1, 1, 3]);
        var values = dl.concat3d([tensor1, tensor2], 2);
        expect(values.shape).toEqual([1, 1, 6]);
        test_util_1.expectArraysClose(values, [1, 2, 3, 4, 5, 6]);
    });
    it('concat axis=2', function () {
        var tensor1 = dl.tensor3d([1, 11, 2, 22, 3, 33, 4, 44], [2, 2, 2]);
        var tensor2 = dl.tensor3d([5, 55, 555, 6, 66, 666, 7, 77, 777, 8, 88, 888], [2, 2, 3]);
        var values = dl.concat3d([tensor1, tensor2], 2);
    ...
    it('concat throws when invalid non-axis shapes, axis=0', function () {
        var axis = 0;
        var x1 = dl.tensor3d([1, 11, 111], [1, 1, 3]);
        var x2 = dl.tensor3d([5, 55, 555, 6, 66, 666, 7, 77, 777, 8, 88, 888], [2, 2, 3]);
        expect(function () { return dl.concat3d([x1, x2], axis); }).toThrowError();
    });
    ...
    it('concat throws when invalid non-axis shapes, axis=2', function () {
        var axis = 2;
        var x1 = dl.tensor3d([1, 11, 2, 22], [1, 2, 2]);
        var x2 = dl.tensor3d([5, 55, 555, 6, 66, 666, 7, 77, 777, 8, 88, 888], [2, 2, 3]);
        expect(function () { return dl.concat3d([x1, x2], axis); }).toThrowError();
    });
    it('gradient concat axis=0', function () {
        var x1 = dl.tensor3d([1, 11, 2, 22], [1, 2, 2]);
        var x2 = dl.tensor3d([5, 55, 6, 66, 7, 77, 8, 88], [2, 2, 2]);
        var dy = dl.tensor3d([66, 6, 55, 5, 44, 4, 33, 3, 22, 2, 11, 1], [3, 2, 2]);
        var axis = 0;
        var grads = dl.grads(function (x1, x2) { return dl.concat3d([x1, x2], axis); });
    ...
    it('gradient concat axis=1', function () {
        var x1 = dl.tensor3d([1, 11, 2, 22], [2, 1, 2]);
        var x2 = dl.tensor3d([3, 33, 4, 44, 5, 55, 6, 66], [2, 2, 2]);
        var dy = dl.tensor3d([66, 6, 55, 5, 44, 4, 33, 3, 22, 2, 11, 1], [2, 3, 2]);
        var axis = 1;
        var grads = dl.grads(function (x1, x2) { return dl.concat3d([x1, x2], axis); });
        var _a = grads([x1, x2], dy), dx1 = _a[0], dx2 = _a[1];
        expect(dx1.shape).toEqual(x1.shape);
    ...
    it('gradient concat axis=2', function () {
        var x1 = dl.tensor3d([1, 2, 3, 4], [2, 2, 1]);
        var x2 = dl.tensor3d([5, 55, 6, 66, 7, 77, 8, 88], [2, 2, 2]);
        var dy = dl.tensor3d([4, 40, 400, 3, 30, 300, 2, 20, 200, 1, 10, 100], [2, 2, 3]);
        var axis = 2;
        var grads = dl.grads(function (x1, x2) { return dl.concat3d([x1, x2], axis); });
        var _a = grads([x1, x2], dy), dx1 = _a[0], dx2 = _a[1];
        expect(dx1.shape).toEqual(x1.shape);
