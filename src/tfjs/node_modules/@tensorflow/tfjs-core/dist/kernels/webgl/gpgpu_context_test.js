...
test_util_1.describeWithFlags('GPGPUContext color texture with float', FLOAT_ENVS, function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
...
var BYTE_ENV = [{ 'WEBGL_FLOAT_TEXTURE_ENABLED': false, 'WEBGL_VERSION': 1 }];
test_util_1.describeWithFlags('GPGPUContext color texture with byte', BYTE_ENV, function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
