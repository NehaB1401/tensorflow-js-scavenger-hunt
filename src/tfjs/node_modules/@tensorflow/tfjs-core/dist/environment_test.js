...
describe('Backend', function () {
    ...
    it('default ENV has cpu and webgl, and webgl is the best available', function () {
        expect(environment_1.ENV.findBackend('webgl') != null).toBe(true);
        expect(environment_1.ENV.findBackend('cpu') != null).toBe(true);
    ...
    it('custom webgl registration', function () {
        ...
        expect(environment_1.ENV.findBackend('webgl')).toBe(backend);
    });
    ...
    it('default custom background null', function () {
        expect(environment_1.ENV.findBackend('custom')).not.toBeDefined();
    });
